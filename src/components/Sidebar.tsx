...
import {
  ...
  LogOut, ChevronDown, ChevronRight, Trash2, Pencil
} from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="w-60 min-w-60 h-screen bg-surface-raised border-r border-surface-border
    ...
    <>
      <div className="group flex items-center gap-1">
        ...
        <button
          ...
          title={showConfirmDelete ? 'Click again to confirm delete' : 'Delete project'}
          className={`opacity-0 group-hover:opacity-100 flex-shrink-0
